function Get-CertificateReport { 
    ...
    #======================================================================
    $logPath = "$PSScriptRoot\Logs\Get-CertificateReport.log" 
    ...
    if (!$Revoked -and !$Pending -and !$Failed)
    {
        try 
        {
            ...
            If ($CertificateTemplateOID)
            {
                ...
                Get-IssuedRequest -CertificationAuthority $CertificateAuthority -Filter $TemplateFilter,$DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {
            ...
            Else
            {
                Get-IssuedRequest -CertificationAuthority $CertificateAuthority -Filter $DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {
                    Write-Verbose "[$($CA.Name)] Processing issued request ID: $($_.RequestID)"                                     
                    $_ | Select-Object *,
                        @{n='TemplateFriendlyName';e={ if($_.CertificateTemplateOid.Value -match "[a-z]"){ $_.CertificateTemplate} elseif ($_.CertificateTemplateOid.FriendlyName -eq $null){$_.CertificateTemplateOid.Value} else { $_.CertificateTemplateOid.FriendlyName }}},
                        @{n='Status';e={ 'Issued' }}
    ...
    if ($Revoked)
    {
        ...
        try 
        {
            ...
            {
                $TemplateFilter = "CertificateTemplate -eq $CertificateTemplateOID"
                Get-RevokedRequest -CertificationAuthority $CertificateAuthority -Filter $TemplateFilter,$DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {
            ...
            Else
            {
                Get-RevokedRequest -CertificationAuthority $CertificateAuthority -Filter $DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {
                    Write-Verbose "[$($CA.Name)] Processing revoked request ID: $($_.RequestID)"
                    $_ | Select-Object *,
                        @{n='TemplateFriendlyName';e={ if($_.CertificateTemplateOid.Value -match "[a-z]"){ $_.CertificateTemplate} elseif ($_.CertificateTemplateOid.FriendlyName -eq $null){$_.CertificateTemplateOid.Value} else { $_.CertificateTemplateOid.FriendlyName }}},
                        @{n='Status';e={ 'Revoked' }}                
    ...
    if ($Pending)
    {
        ...
        try 
        {
            ...
            {
                $TemplateFilter = "CertificateTemplate -eq $CertificateTemplateOID"
                Get-PendingRequest -CertificationAuthority $CertificateAuthority -Filter $TemplateFilter,$DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {                    
            ...
            Else
            {
                Get-PendingRequest -CertificationAuthority $CertificateAuthority -Filter $DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {                   
                    Write-Verbose "[$($CA.Name)] Processing pending request ID: $($_.RequestID)"
                    $_ | Select-Object *,
                        @{n='TemplateFriendlyName';e={ if($_.CertificateTemplateOid.Value -match "[a-z]"){ $_.CertificateTemplate} elseif ($_.CertificateTemplateOid.FriendlyName -eq $null){$_.CertificateTemplateOid.Value} else { $_.CertificateTemplateOid.FriendlyName }}},
                        @{n='Status';e={ 'Pending' }}
    ...
    if ($Failed)
    {
        ...
        try 
        {
            ...
            {
                $TemplateFilter = "CertificateTemplate -eq $CertificateTemplateOID"
                Get-AdcsDatabaseRow -CertificationAuthority $CertificateAuthority -Table Failed -Filter $TemplateFilter,$DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {                    
            ...
            Else
            {
                Get-AdcsDatabaseRow -CertificationAuthority $CertificateAuthority -Table Failed -Filter $DateFilter,$RequestIDFilter -ErrorAction Stop | ForEach-Object {                                     
                    Write-Verbose "[$($CA.Name)] Processing failed request ID: $($_.RequestID)"
                    $_ | Select-Object *,
                        @{n='TemplateFriendlyName';e={ if($_.CertificateTemplateOid.Value -match "[a-z]"){ $_.CertificateTemplate} elseif ($_.CertificateTemplateOid.FriendlyName -eq $null){$_.CertificateTemplateOid.Value} else { $_.CertificateTemplateOid.FriendlyName }}},
                        @{n='Status';e={ 'Failed' }}
